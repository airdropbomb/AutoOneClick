...
(function() {
    ...
    function initializeAutoCloseScript() {
        ...
        function validateLicenseKey() {
            ...
            licenseKey = licenseInput ? licenseInput.value.trim() : '';
            if (!licenseKey) {
                updateStatus('License key required!', 'error');
            ...
            GM_xmlhttpRequest({
                ...
                onload: function(response) {
                    ...
                    try {
                        ...
                        updateStatus('Error parsing server response.', 'error');
        ...
        function updateButtonStates() {
            ...
            if (validateBtn) validateBtn.disabled = isLicenseValid;
        }
